...
import { defaultAppearance, parseCustomPalette, themeGradient, themePresets, tokensForAppearance, type AppearancePreference, type ThemeTokens } from "./appearance";
...
function BrandPreview({ initials, tokens }: { initials: string; tokens: ThemeTokens }) { return <div className="brand-mark preferences-mark" style={{ background: themeGradient(tokens) }} aria-label={`${initials} personal brand mark`}>{initials}</div>; }
